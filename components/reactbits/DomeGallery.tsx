...
type DomeGalleryProps = {
  ...
  onImageClick?: (index: number, src: string, alt: string) => void;
};
  ...
  const onTileClick = useCallback(
    (e: React.MouseEvent<HTMLDivElement>) => {
      ...
      if (onImageClick) {
        ...
        const alt = img?.alt || '';
        const itemIndex = parseInt(parent?.dataset.itemIndex || '0', 10);
        onImageClick(itemIndex, src, alt);
        return;
      }
          ...
          <div ref={sphereRef} className="sphere">
            {items.map((it, i) => (
              <div
                ...
                data-item-index={it.originalIndex ?? i}
                style={
                  {
