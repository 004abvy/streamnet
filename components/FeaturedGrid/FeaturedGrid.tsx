              ...
              >
                ...
                <div className="relative z-10 flex h-full w-full items-center justify-center p-4">
                  <div className="mx-auto max-w-3xl space-y-6 text-center">
                    <h1 className="line-clamp-2 text-xl font-bold leading-tight tracking-tighter md:text-4xl text-white">
                      {displayTitle}
                    </h1>
                    <div className="flex flex-col items-center justify-center gap-4 md:flex-row">
                      <Link
                        href={watchHref}
                        className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 shadow rounded-md px-8 h-11 w-[200px] md:w-auto bg-white text-black hover:bg-gray-200"
                      >
                      ...
                      <Link
                        href={detailHref}
                        className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 shadow-sm h-11 px-8 w-[200px] md:w-auto border border-white/20 bg-black/40 text-white hover:bg-black/60 backdrop-blur-sm"
                      >
                        About
